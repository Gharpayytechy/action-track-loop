  ...
  return (
    <div className="px-4 md:px-8 py-6 max-w-[1500px] mx-auto">
      ...
      {control ? (
        <section className="rounded-2xl border border-destructive/30 bg-destructive/5 p-4 md:p-5 mb-6">
          ...
          <ul className="space-y-2 text-sm">
            <Need n={block.people.idle} what="people idle" to="/roster" cta="Open roster" />
            <Need n={block.chats.waitingUs} what="chats waiting on Gharpayy" to="/live" cta="Open chats" />
            <Need n={block.tours.unconfirmed} what="tours not confirmed" to="/reports" cta="Open tours" />
            <Need n={Math.max(block.people.present - block.reporting.cp5, 0)} what="5 PM reports missing" to="/reporting" cta="Open reporting" />
      ...
      <div className="mt-6 text-xs text-muted-foreground">
        Drill deeper: <Link to="/people" className="text-primary hover:underline">People</Link> ·{" "}
        <Link to="/reporting" className="text-primary hover:underline">Reporting OS</Link> ·{" "}
        <Link to="/admin/report-center" className="text-primary hover:underline">Report Center</Link> ·{" "}
        <Link to="/founder" className="text-primary hover:underline">Founder mode</Link>
      </div>
    </div>
  );
}
