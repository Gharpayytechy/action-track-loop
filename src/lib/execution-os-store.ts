...
export const STAGE_META: Record<Stage, { label: string; time: string; kind: string; needsSelfie: boolean; needsWa?: WaCheckpoint }> = {
  ...
  resume1:  { label: "Recovery Commit · 2:00 PM", time: "14:00", kind: "resume",  needsSelfie: true },
  block2:   { label: "Block 2 · Execute",     time: "14:00–17:00", kind: "block",  needsSelfie: false },
