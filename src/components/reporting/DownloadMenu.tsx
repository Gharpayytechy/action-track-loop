...
import { peopleInScope, scopeBlock, PERIOD_LABEL, type Period, type Scope } from "@/lib/command-center/metrics";
import { buildFounderUpdate, checkpointNow, scopeLabel } from "@/lib/reporting/founder-update";
import { FORMAT_SECTIONS } from "@/lib/reporting/founder-update";
import { copyToClipboard } from "@/lib/execution/wa-format";
import { logSent } from "@/lib/reporting/report-store";
